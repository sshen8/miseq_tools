...
if __name__ == "__main__":
    ...
    parser_samplesheet = subparsers.add_parser("samplesheet", help="Format sample sheet for Miseq")
    ...
    parser_pre = subparsers.add_parser("pre", help="Full pre-Miseq pipeline: includes samplesheet, kapa, qubit, combine, and pool")
